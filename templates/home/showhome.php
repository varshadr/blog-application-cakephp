				...
				<div class="collapse navbar-collapse" id="navbarContent">
					<ul id="menu" class="menu navbar-nav ">
						...
						<li class="nav-item dropdown">
							<a class="nav-link dropdown-toggle" href="/blogs" id="navbarDropdown2" role="button" data-toggle="dropdown"
								aria-haspopup="true" aria-expanded="false">
								Blog Posts
							</a>
							<div class="dropdown-menu" aria-labelledby="navbarDropdown2">
								<a class="dropdown-item" href="/blogs/create">Create blog</a>
								<!-- <a class="dropdown-item" href="/blogs/viewblog">View blog</a> -->
								<a class="dropdown-item" href="/blogs/listblogs">List all blogs</a>
							</div>
						</li>

						<li class="nav-item"><a href="/public/aboutus" class="nav-link">About</a></li>
